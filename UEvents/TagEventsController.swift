//
//  TagEventsController.swift
//  UEvents
//
//  Created by Sameet Sapra on 8/6/14.
...
class TagEventsController: GAITrackedViewController, UITableViewDataSource, UITableViewDelegate, FilteredProtocol{
    ...
    func tableView(tableView: UITableView!, cellForRowAtIndexPath indexPath: NSIndexPath!) -> UITableViewCell! {
        ...
        if (listItem is Event){
            ...
            cell = EventCell(style: UITableViewCellStyle.Subtitle, reuseIdentifier: kCellIdentifier)
